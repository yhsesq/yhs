...
Sentinel v1.2.1c-USR - Secure drive checker. Individual (non root) user version.
...
if (geteuid()==0){printf("\n!!0003!!\nI_Check: Only non root users can run this function. [FAIL]"); printf("!!!!!!!!");exit(99);}
...
if (argc == 1)
{printf("\n ----");
printf("\nSentinel v1.2.1c-USR -- Drive integrity checker. INDIVIDUAL USER VERSION. Not for ROOT users. Rename to sentinel and copy to users home directory.");
printf("\n (C) 1999,2000,2001 Zurk Technology Inc. ");
printf("\n (C) 1999,2000,2001 Free Software Foundation Inc. ");
...
if (geteuid()==0){printf("\n!!0014!!\nERROR: Only the normal user and not root or super-user (UID:0) can run this function."); printf("!!!!!!!!");exit(100);}
...
fprintf(tmpp,"static char *pdir=\"\";\n");
fprintf(tmpp,"static char *pfile=\"sentinel.\";\n");
fprintf(tmpp,"static char *psig=\"sentinel.sig.\";\n");
fprintf(tmpp,"static char *batchfile=\"sentinel.batch\";\n");
fprintf(tmpp,"static char *executable=\"sentinel\";\n");
fprintf(tmpp,"static char *filelist=\"sentinel.1\";\n",pdir);
fprintf(tmpp,"static char *logfile=\"sentinel.2\";\n",pdir);
fprintf(tmpp,"static char *readmefile=\"README.sentinel\";\n");
fprintf(tmpp,"static char *executablesig=\"sentinel.sig.0\";\n");
fprintf(tmpp,"static char *filelistsig=\"sentinel.sig.1\";\n");
fprintf(tmpp,"static char *logfilesig=\"sentinel.sig.2\";\n");
fprintf(tmpp,"static char *filelistbak=\"sentinel.1.bak\";\n");
fprintf(tmpp,"static char *logfilebak=\"sentinel.2.bak\";\n");
fprintf(tmpp,"static char *config=\"sentinel.conf\";\n");
fprintf(tmpp,"static char *lock=\"sentinel.lock\";\n");
fprintf(tmpp,"static char *tmp=\"sentinel.tmp\";\n");
fprintf(tmpp,"static char *tmpx=\"sentinel.tmpx\";\n");
