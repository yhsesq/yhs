...
class JCtp implements Runnable{
  InputStream in;
  OutputStream out;
  JYannelSftp c;
  ...
  JCtp(JYannelSftp c, InputStream in, OutputStream out){
    this.c=c;
    this.in=in;
    this.out=out;
  }
...
//	  String p2=p1;
	  ...
	  try{
	    JYtpProgressMonitor monitor=new MyProgressMonitor(out);
...
//	  out.print(help+"\n");
  ...
  public static class MyProgressMonitor implements JYtpProgressMonitor{
    OutputStream out;
