...
@version	2.0, 2004/08/08
@version	1.0, 2000/01/19
@author		Yohann Sulaiman yhs@users.sf.net
@Original author Ken Klinner, kklinner@opiom.com
 */
										...
										FindProgressCallback
{
	...
	*/
	...
	public void run ()
	{
		...
		{ System.err.println(chooser.getCurrentDirectory()+e.toString());
		}
		finally
		{
	...
	*/
	class FindTabs extends JTabbedPane
	{
		...
		*/
		...
		{
			if (resultsPanel != null) {resultsPanel.append(f);resultsPanel.show();}
		}
